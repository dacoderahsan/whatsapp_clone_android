...
public class ChatActivity extends AppCompatActivity {
    ...
    private String savedCurrentTime, savedCurrentDate;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        if(requestCode==438 && resultCode==RESULT_OK && data!=null && data.getData()!=null)
        {
            ...
            loadingBar.setMessage("Please wait while we send...");
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task)
                                {
                                    ...
                                    {
                                        loadingBar.dismiss();
                                        Toast.makeText(ChatActivity.this,"Message not sent successfully!",Toast.LENGTH_SHORT).show();
                                    }
    ...
    private void SendMessage()
    {
        ...
        {
            Toast.makeText(ChatActivity.this, "Can't Send an Empty Text", Toast.LENGTH_SHORT).show();
        }
        else
        {
